...
public class WebConfig extends WebMvcConfigurerAdapter{
	...
	public MultipartResolver multipartResolver() throws IOException{
		//the default server temp folder will be used this way
		/*return new CommonsMultipartResolver();*/
		
		CommonsMultipartResolver multipartResolver = new CommonsMultipartResolver();
		multipartResolver.setUploadTempDir(new FileSystemResource("D:/d/data/temp/upload"));
		multipartResolver.setMaxUploadSize(2*1024*1024);//set max file size
		//cannot set max request size
